...
export default class FilterTrainTicket extends Component {
    constructor(props) {
        super(props)
        this.state = {
            checkBox: false,
            ...
            <Container>
                ...
                <ScrollView style={styles.srollView}>
                    ...
                    <View style={styles.card}>
                        ...
                        <View style={{ flex: 1, flexDirection: 'row' }}>
                            <TouchableOpacity style={styles.buttonPickerKelas}>
                    ...
                    <View style={styles.card}>
                        ...
                        <ListItem>
                            ...
                            <Body>
                                <Text>ARGO MURIA 14</Text>
                            </Body>
                        </ListItem>
                        <ListItem>
                            <CheckBox checked={false} color="#f97432" />
                            <Body>
                                <Text>ARGO BROMO ANGGREK 2</Text>
                            </Body>
                        </ListItem>
                        <ListItem>
                            <CheckBox checked={false} color="#f97432" />
                            <Body>
                                <Text>ARGO BROMO ANGGREK LUXURY 2L</Text>
                            </Body>
                        </ListItem>
                        <ListItem>
                            <CheckBox checked={false} color="#f97432" />
                            <Body>
                                <Text>BANGUNKARTA 56</Text>
                            </Body>
                        </ListItem>
                        <ListItem>
                            <CheckBox checked={false} color="#f97432" />
                            <Body>
                                <Text>BANGUNKARTA PRIORITY 56P</Text>
                            </Body>
                        </ListItem>
                        <ListItem>
                            <CheckBox checked={false} color="#f97432" />
                            <Body>
                                <Text>ARGO SINDORO 12</Text>
                            </Body>
                        </ListItem>
                    </View>
                </ScrollView>
