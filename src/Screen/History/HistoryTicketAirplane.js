...
export default class HistroyTicketAirplane extends Component {
            ...
            HistroyTicketTrain: [
                {
                    ...
                    codeNameFromAirPort: 'JKT',
                    codeNameToAirPort: 'DPS',
                    nameFromAirPort: 'Jakarta',
                    nameToAirPort: 'Bali/Denpasar'
                },
                {
                    dateOfDeparture: '08 Nov 2019',
                    totalPassenger: '1 Penumpang (1 Dewasa)',
            ...
            <Container>
                <Header style={styles.header} androidStatusBarColor='#f97432' noShadow={true}>
                    <Grid>
                        ...
                        <View>
                            <Button
                                style={{ height: 40, width: 40, backgroundColor: '#d58568', position: 'absolute' }}
                                        ...
                                        <Grid style={{ marginVertical: 5 }}>
                                            <Col style={{ width: '70%' }}>
                                                <Text style={{ color: '#4d4f44' }}>
                                                    <SimpleLineIcons style={[{ color: '#f97432' }]} size={16} name={'plane'} /> {item.codeNameFromAirPort} <MaterialCommunityIcons size={15} name={'arrow-right'} style={{ color: '#898989' }} /> {item.codeNameToAirPort}
                                                </Text>
                                                <Text style={{ fontSize: 12, color: '#898989', marginLeft: 20 }}>{item.nameFromAirPort} - {item.nameToAirPort} </Text>
                                            </Col>
                                            <Col style={{ width: '30%' }}>
